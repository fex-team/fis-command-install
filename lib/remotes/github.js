...
var exports = module.exports = function GithubRepos(address, options) {
    ...
    this.author = RegExp.$1 || options.defaultAuthor;
    this.name = RegExp.$2;
                ...
                return self
                    ...
                    .then(function(versions) {
                        ...
                        if (!self.version) {
                            ...
                            if (!resolved) {
                                throw new Error('cannot find matched version');
                            }
...
exports.accept = function(address, asDefault) {
    ...
    var defaultAuthor = options.defaultAuthor;
    ...
    return reg.test(address) ||
        ...
        defaultAuthor && regShorter.test(address);
};

exports.options = {
    defaultAuthor: 'fis-components'
};
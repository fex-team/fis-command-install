...
function requestAPI(uri, token, callback) {
    ...
    request({
        ...
        headers: {
            'User-Agent': 'request',
            'PRIVATE-TOKEN': DEFAULT_TOKEN || token
        }
...
var exports = module.exports = function GitlabRepos(address, options) {
            ...
            .then(function(location) {
                ...
                return self
                    ...
                    .then(function() {
                        ...
                        return request('http://gitlab.baidu.com/api/v3/projects/' + projectId + '/repository/blobs/'+self.version + '?filepath=component.json', options.token);
                    })
                    ...
                    .error(function(e) {
                        if (/Not\sFound/i.test(e.message)) {
                            ...
                            throw new Error(e.status + ' ' + e.message + ' while loading github:' + self.address);
                        }
                    })
    ...
    this.getAvaiableVersions = function () {
        ...
        return request('http://gitlab.baidu.com/api/v3/projects/' + projectId + '/repository/tags', options.token)

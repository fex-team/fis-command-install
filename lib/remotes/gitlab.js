                ...
                return self
                    ...
                    .error(function(e) {
                        if (/Not\sFound/i.test(e.message)) {
                            ...
                            throw new Error(e.status + ' ' + e.error + ' while loading gitlab:' + self.domain + self.address);
                        }
                    })
    ...
    this.getAvaiableVersions = function () {
        ...
        return request(self.domain + 'api/v3/projects/' + projectId + '/repository/tags', options.token)
            ...
            .then(function(tags) {
                ...
                // no tags? now branchs.
                if (!versions.length) {
                    return request(self.domain + 'api/v3/projects/' + projectId + '/repository/branches')
